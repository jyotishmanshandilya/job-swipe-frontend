...
/** A rounded organic blob — background accent behind headings/badges. */
export function Blob({
  ...
  return (
    ...
    >
      <path
        d="M50 18c7 8 6 22-3 30s-25 9-33 1S6 26 15 17 43 10 50 18z"
        fill={color}
      />
    </svg>
  );
...
/** A tiny twinkle/sparkle — scatter accent. */
